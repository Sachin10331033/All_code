	...
	public static void handleWelcomeScreenInput() {
		...
		do {
			try {
				...
				switch (input) {
				case 1:
					FileOpr.displayAllFiles("main");
					break;
				case 2:
					Task.handleFileMenuOptions();
					break;
				case 3:
		...
		do {
			try {
				...
				case 1:
					...
					FileOpr.createFile(fileToAdd, sc);
				...
				case 2:
					...
					FileOpr.createMainFolderIfNotPresent("main");
					List<String> filesToDelete = FileOpr.displayFileLocations(fileToDelete, "main");
					...
					if (idx != 0) {
						FileOpr.deleteFileRecursively(filesToDelete.get(idx - 1));
					} else {
						
						// If idx == 0, delete all files displayed for the name
						for (String path : filesToDelete) {
							FileOpr.deleteFileRecursively(path);
						}
					}
				...
				case 3:
					...
					FileOpr.createMainFolderIfNotPresent("main");
					FileOpr.displayFileLocations(fileName, "main");
